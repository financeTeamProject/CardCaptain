...
<div id="content">
	<div id="contentMenu">
		...
		<div class="review_area" id="reviewArea">
			...
			<div class="review_content_area" id="reviewContentArea">
			<c:set var="size" value="${fn:length(reviewList)}" />
			<c:forEach var = "i" begin="0" end="${size - 1}">
				<div class="review_box" id="${reviewList[i].REVIEW_NO}">
					<div class="review_content">${reviewList[i].REVIEW_NO}</div>	
					<div class="review_content">${reviewList[i].NICKNAME}</div>	
					<c:choose>
						<c:when test="${reviewList[i].SCORE eq 1}">
						<div class="review_content">★☆☆☆☆</div>
						</c:when>
						<c:when test="${reviewList[i].SCORE eq 2}">
						<div class="review_content">★★☆☆☆</div>
						</c:when>
						<c:when test="${reviewList[i].SCORE eq 3}">
						<div class="review_content">★★★☆☆</div>
						</c:when>
						<c:when test="${reviewList[i].SCORE eq 4}">
						<div class="review_content">★★★★☆</div>
						</c:when>
						<c:otherwise>
						<div class="review_content">★★★★★</div>
					...
					<div class="review_content">${reviewList[i].CARD_NAME}</div>	
					<div class="review_content">${reviewList[i].TITLE}</div>	
					<div class="review_content">${reviewList[i].TEXT}</div>	
					<div class="review_content">${reviewList[i].ADD_DATE}</div>	
					<div class="review_content">${reviewList[i].STATUS_NO}</div>
					<input type="hidden" name="reviewMNo" value="${reviewList[i].MEMBER_NO}" />
				</div>
			</c:forEach>
			</div>
			<form action="#" id="actionForm" method="post">
