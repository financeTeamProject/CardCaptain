	...
	<div class="title">소비심리테스트</div>
		<div class="content">
			<div class="content_1">
				...
				<input type="radio" name="hobby16" id="hobby16_5" value="5"><label for="hobb16_5">상당히 그렇다</label>
			</div>
		</div>
		<div class="content">
			<div class="content_1">
				...
				<input type="radio" name="hobby17" id="hobby17_5" value="5"><label for="hobb17_5">상당히 그렇다</label>
			</div>
		</div>
		<div class="content">
			<div class="content_1">
				...
				<input type="radio" name="hobby18" id="hobby18_5" value="5"><label for="hobb18_5">상당히 그렇다</label>
			</div>
		</div>
		<div class="content">
			<div class="content_1">
				...
				<input type="radio" name="hobby19" id="hobby19_5" value="5"><label for="hobb19_5">상당히 그렇다</label>
			</div>
		</div>
		<div class="content">
			<div class="content_1">
				...
				<input type="radio" name="hobby20" id="hobby20_5" value="5"><label for="hobb20_5">상당히 그렇다</label>
			</div>
		</div>
	<div id="sobiButton">
